...
msg_qpsk = pskmod(msg_gry_enc,M);    %QPSK modulation
...
x = [1,1;1,-1;-1,1;-1,-1];   %qpsk所有可能，16种，用x_base生成

y = zeros(4, 2);   %y is Hx, 16种
flag = zeros(1,4);
...
%% QPSK解调%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
msg_gry_demod = pskdemod(msg_MIMO_rx_re,M);      %qpsk demodulate
