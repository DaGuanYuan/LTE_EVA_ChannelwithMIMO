...
msg_ray11_01_1 = 0.5*msg_ofdm_re01_1;     %h11*x1,x1=0
msg_ray11_10_1 = 0.5*msg_ofdm_re10_1;     %h11*x1,x1=1
...
for j = 1 : group_prl       
   %% DFT%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
   msg_nocp01_1(j,:) = msg_MIMO_re01_1(j,13:num_carrier+len_cp);    %wipe off cp
   msg_nocp01_2(j,:) = msg_MIMO_re01_2(j,13:num_carrier+len_cp);    %wipe off cp   
   msg_nocp10_1(j,:) = msg_MIMO_re10_1(j,13:num_carrier+len_cp);    %wipe off cp
   msg_nocp10_2(j,:) = msg_MIMO_re10_2(j,13:num_carrier+len_cp);    %wipe off cp
