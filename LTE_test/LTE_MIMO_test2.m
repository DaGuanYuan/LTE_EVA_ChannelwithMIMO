...
[msg_ray11_01_1, pathgain11] = step(Ray_chan11, msg_ofdm_re01_1);     %h11*x1,x1=0
msg_ray11_10_1 = step(Ray_chan11, msg_ofdm_re10_1);     %h11*x1,x1=1

[msg_ray12_01_2, pathgain12] = step(Ray_chan12, msg_ofdm_re01_2);     %h12*x2,x2=1
msg_ray12_10_2 = step(Ray_chan12, msg_ofdm_re10_2);     %h12*x2,x2=0
...
[msg_ray21_01, pathgain21] = step(Ray_chan21, msg_ofdm_re01_1);     %h21*x1,x1=0
msg_ray21_10 = step(Ray_chan21, msg_ofdm_re10_1);     %h21*x1,x1=1

[msg_ray22_01, pathgain22] = step(Ray_chan22, msg_ofdm_re01_2);     %h22*x2,x2=1
msg_ray22_10 = step(Ray_chan22, msg_ofdm_re10_2);     %h22*x2,x2=0
...
msg_MIMO_re01_1 = transpose(reshape(msg_MIMO01_1, size(msg_MIMO01_1,1)*size(msg_MIMO01_1,2)/group_prl,group_prl));   %返回到并行子载波形式
msg_MIMO_re01_2 = transpose(reshape(msg_MIMO01_2, size(msg_MIMO01_2,1)*size(msg_MIMO01_2,2)/group_prl,group_prl));   %返回到并行子载波形式
msg_MIMO_re10_1 = transpose(reshape(msg_MIMO10_1, size(msg_MIMO10_1,1)*size(msg_MIMO10_1,2)/group_prl,group_prl));   %返回到并行子载波形式
msg_MIMO_re10_2 = transpose(reshape(msg_MIMO10_2, size(msg_MIMO10_2,1)*size(msg_MIMO10_2,2)/group_prl,group_prl));   %返回到并行子载波形式
