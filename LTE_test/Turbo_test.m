...
% msg_conv = msg;     %test
% msg_turbo_cascade = msg_conv; %test
%% 行列交织 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
msg_ofdm10_1 = transpose(zeros(group_prl, num_carrier+len_cp));
msg_ofdm10_2 = transpose(zeros(group_prl, num_carrier+len_cp));
msg_ofdm01_1 = transpose(zeros(group_prl, num_carrier+len_cp));
msg_ofdm01_2 = transpose(zeros(group_prl, num_carrier+len_cp));

msg_ray11_01_1 = transpose(zeros(group_prl, num_carrier+len_cp));
msg_ray11_10_1 = transpose(zeros(group_prl, num_carrier+len_cp));
msg_ray12_01_2 = transpose(zeros(group_prl, num_carrier+len_cp));
msg_ray12_10_2 = transpose(zeros(group_prl, num_carrier+len_cp));
msg_ray21_01 = transpose(zeros(group_prl, num_carrier+len_cp));
msg_ray21_10 = transpose(zeros(group_prl, num_carrier+len_cp));
msg_ray22_01 = transpose(zeros(group_prl, num_carrier+len_cp));
msg_ray22_10 = transpose(zeros(group_prl, num_carrier+len_cp));
msg_MIMO01_1 = transpose(zeros(group_prl, num_carrier+len_cp));
msg_MIMO10_1 = transpose(zeros(group_prl, num_carrier+len_cp));
msg_MIMO01_2 = transpose(zeros(group_prl, num_carrier+len_cp));
msg_MIMO10_2 = transpose(zeros(group_prl, num_carrier+len_cp));
msg_awgn01_1 = zeros(group_prl, num_carrier+len_cp);
msg_awgn01_2 = zeros(group_prl, num_carrier+len_cp);
msg_awgn10_1 = zeros(group_prl, num_carrier+len_cp);
msg_awgn10_2 = zeros(group_prl, num_carrier+len_cp);
Pathgain = zeros(num_carrier+len_cp,group_prl);
...
for j = 1 : group_prl
   ...
   msg_ofdm01_1(:,j) = transpose(cat(2,cp01_1(j,:),msg_idft01_1(j,:)));    %add cp,concatenate matrix
   msg_ofdm01_2(:,j) = transpose(cat(2,cp01_2(j,:),msg_idft01_2(j,:)));    %add cp,concatenate matrix
   msg_ofdm10_1(:,j) = transpose(cat(2,cp10_1(j,:),msg_idft10_1(j,:)));    %add cp,concatenate matrix
   msg_ofdm10_2(:,j) = transpose(cat(2,cp10_2(j,:),msg_idft10_2(j,:)));    %add cp,concatenate matrix
...
%%%%%%%%%%%%%%%%% 4 Rayleigh represent MIMO%%%%%%%%%%%%%%%%%%    
    ...
    msg_ray11_01_1(:,j) = step(Ray_chan11, msg_ofdm01_1(:,j));     %h11*x1,x1=0
    msg_ray11_10_1(:,j) = step(Ray_chan11, msg_ofdm10_1(:,j));     %h11*x1,x1=1

    msg_ray12_01_2(:,j) = step(Ray_chan12, msg_ofdm01_2(:,j));     %h12*x2,x2=1
    msg_ray12_10_2(:,j) = step(Ray_chan12, msg_ofdm10_2(:,j));     %h12*x2,x2=0

    msg_MIMO01_1(:,j) = msg_ray11_01_1(:,j) + msg_ray12_01_2(:,j);      %y1 = h11*x1 + h12*x2,x1=0,x2=1
    msg_MIMO10_1(:,j) = msg_ray11_10_1(:,j) + msg_ray12_10_2(:,j);      %y1 = h11*x1 + h12*x2,x1=1,x2=0

    msg_ray21_01(:,j) = step(Ray_chan21, msg_ofdm01_1(:,j));     %h21*x1,x1=0
    msg_ray21_10(:,j) = step(Ray_chan21, msg_ofdm10_1(:,j));     %h21*x1,x1=1

    msg_ray22_01(:,j) = step(Ray_chan22, msg_ofdm01_2(:,j));     %h22*x2,x2=1
    msg_ray22_10(:,j) = step(Ray_chan22, msg_ofdm10_2(:,j));     %h22*x2,x2=0

    msg_MIMO01_2(:,j) = msg_ray21_01(:,j) + msg_ray22_01(:,j);      %y2 = h21*x1 + h22*x2,x1=0,x2=1
    msg_MIMO10_2(:,j) = msg_ray21_10(:,j) + msg_ray22_10(:,j);      %y2 = h21*x1 + h22*x2,x1=1,x2=0

    %     [msg_MIMO, MIMO_PATHGAINS] = step(MIMO_chan, msg_ofdm_re);   %pass MIMO, y = Hx
    msg_awgn01_1(j,:) = transpose(awgn(msg_MIMO01_1(:,j),SNR_awgn,'measured',19980611));      %pass awgn,接收信号y = Hx + n
    msg_awgn01_2(j,:) = transpose(awgn(msg_MIMO01_2(:,j),SNR_awgn,'measured',19980611));      %pass awgn,接收信号y = Hx + n
    msg_awgn10_1(j,:) = transpose(awgn(msg_MIMO10_1(:,j),SNR_awgn,'measured',19980611));      %pass awgn,接收信号y = Hx + n
    msg_awgn10_2(j,:) = transpose(awgn(msg_MIMO10_2(:,j),SNR_awgn,'measured',19980611));      %pass awgn,接收信号y = Hx + n
...
% msg_MIMO_re10_2 = transpose(reshape(msg_awgn10_2, size(msg_awgn10_2,1)*size(msg_awgn10_2,2)/group_prl,group_prl));   %返回到并行子载波形式
   ...
   %% DFT%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
   msg_nocp01_1(j,:) = msg_awgn01_1(j,len_cp+1:num_carrier+len_cp);    %wipe off cp
   msg_nocp01_2(j,:) = msg_awgn01_2(j,len_cp+1:num_carrier+len_cp);    %wipe off cp   
   msg_nocp10_1(j,:) = msg_awgn10_1(j,len_cp+1:num_carrier+len_cp);    %wipe off cp
   msg_nocp10_2(j,:) = msg_awgn10_2(j,len_cp+1:num_carrier+len_cp);    %wipe off cp
...
BER_T_14 = sum(msg_wrong)/num_bit;
...
% msg_rx = msg_deintrlv_code;
msg_wrong = abs(msg_rx - msg);      %for turbo code
BER_T_15 = sum(msg_wrong)/num_bit;
...
% msg_rx = msg_deintrlv_code;
msg_wrong = abs(msg_rx - msg);      %for turbo code
BER_T_16 = sum(msg_wrong)/num_bit;
...
% msg_rx = msg_deintrlv_code;
msg_wrong = abs(msg_rx - msg);      %for turbo code
BER_T_17 = sum(msg_wrong)/num_bit;
...
% msg_rx = msg_deintrlv_code;
msg_wrong = abs(msg_rx - msg);      %for turbo code
BER_T_18 = sum(msg_wrong)/num_bit;
...
% msg_rx = msg_deintrlv_code;
msg_wrong = abs(msg_rx - msg);      %for turbo code
BER_T_19 = sum(msg_wrong)/num_bit;
...
% msg_rx = msg_deintrlv_code;
msg_wrong = abs(msg_rx - msg);      %for turbo code
BER_T_20 = sum(msg_wrong)/num_bit;
...
% msg_rx = msg_deintrlv_code;
msg_wrong = abs(msg_rx - msg);      %for turbo code
BER_C_20 = sum(msg_wrong)/num_bit;
...
% msg_rx = msg_deintrlv_code;
msg_wrong = abs(msg_rx - msg);      %for turbo code
BER_C_19 = sum(msg_wrong)/num_bit;
...
% msg_rx = msg_deintrlv_code;
msg_wrong = abs(msg_rx - msg);      %for turbo code
BER_C_18 = sum(msg_wrong)/num_bit;
...
% msg_rx = msg_deintrlv_code;
msg_wrong = abs(msg_rx - msg);      %for turbo code
BER_C_17 = sum(msg_wrong)/num_bit;
...
% msg_rx = msg_deintrlv_code;
msg_wrong = abs(msg_rx - msg);      %for turbo code
BER_C_16 = sum(msg_wrong)/num_bit;
...
% msg_rx = msg_deintrlv_code;
msg_wrong = abs(msg_rx - msg);      %for turbo code
BER_C_15 = sum(msg_wrong)/num_bit;
...
% msg_rx = msg_deintrlv_code;
msg_wrong = abs(msg_rx - msg);      %for turbo code
BER_C_14 = sum(msg_wrong)/num_bit;